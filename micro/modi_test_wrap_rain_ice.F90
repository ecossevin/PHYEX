MODULE MODI_TEST_WRAP_RAIN_ICE
IMPLICIT NONE
INTERFACE
...
!-----------------------------------------------------------------
!     ######spl
      SUBROUTINE TEST_RAIN_ICE ( D, CST, PARAMI, ICEP, ICED, ELECP, ELECD, BUCONF,     &
...
!-------------------------------------------------------------------------------
!
END SUBROUTINE TEST_RAIN_ICE
END INTERFACE
END MODULE MODI_TEST_WRAP_RAIN_ICE
