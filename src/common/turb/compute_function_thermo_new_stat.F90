SUBROUTINE COMPUTE_FUNCTION_THERMO_NEW_STAT (D, PALP, PBETA, PGAM, PLTT, PC, PT, PEXN, PCP, PLOCPEXN, PAMOIST, PATHETA, IIJB,  &
  & IKT, ZDRVSATDT, ZHOOK_HANDLE2, ZEPS, IIJE, ZRVSAT, CST, PPABST)
    !     ########################################################################
    !!
