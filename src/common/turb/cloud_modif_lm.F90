...
!-----------------------------------------------------------------
  SUBROUTINE CLOUD_MODIF_LM (OCLOUDMODIFLM, D, TPFILE, PRT, PTKET, PDZZ, TZFIELD, PLM, PZZ, PETHETA, PSHEAR, KRRI, PD, &
...
!$acc end kernels
      ...
      CASE ('DELT')
        ...
        & IKU, PDIRCOSZW, IKTB, ZHOOK_HANDLE2, IIJE, PD, GOCEAN, IKL, IKB, TURBN, JK, PDXX, IKTE, ODZ=.TRUE.)
        !
      ...
      CASE ('DEAR')
        ...
        & PSRCT, PAMOIST, PALPHA, PDIRCOSZW, ZWORK1, TURBN, PDXX, PVAR, &
