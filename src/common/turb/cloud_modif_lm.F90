...
!-----------------------------------------------------------------
  ...
  & CST, CSTURB, PCOEF_AMPL, PTHVREF, PDRTDZ, PDTHLDZ, OOCEAN, PTHLT, PWORK2, GOCEAN, PTHLM, PRM, &
  & LOCPEXNM, OCOMPUTE_SRC, PSRCT, PCOEF_AMPL_SAT, PAMOIST, PALPHA, PDIRCOSZW, PWORK1, &
...
!$acc end kernels
        ...
        !           -------------------
      CASE ('DELT')
        CALL DELT(PLM_CLOUD, PWORK2, D, PWORK1, O2D, PZZ, PDYY, PALPHA,  &
