...
!$acc end kernels
  ...
  !           -----------------------
  IF (OCLOUDMODIFLM) CALL CLOUD_MODIF_LM(OCLOUDMODIFLM, ZLM_CLOUD, D, TPFILE, PRT, PTKET, PDZZ,  &
  & TZFIELD,   ZLM, PZZ, ZETHETA, ZSHEAR, KRRI, IIJE, ZD, ZEMOIST, CST,   CSTURB, ZCOEF_AMPL, PTHVREF, ZDRTDZ, ZDTHLDZ, OOCEAN, IKT, &
  &  IKU, ZPENTE,   PTHLT, ZWORK2, GOCEAN, ZTHLM, ZRM, JK, IKTE, ZLOCPEXNM, OCOMPUTE_SRC,  &
  & PSRCT, PCOEF_AMPL_SAT,   IKE, JIJ, ZAMOIST, IKA, ZCOEF_AMPL_CEI_NUL, ZALPHA, PDIRCOSZW, ZWORK1,  &
  & IKTB, PCEI,   IKL, TURBN, PCEI_MIN, PDXX, ZVAR, IIJB, O2D, HTURBLEN_CL, PDYY, ZHOOK_HANDLE2, KRR,  &
  & ZWORK2D, IKB, PCEI_MAX, ZATHETA)
END IF
! end LHARRAT
