...
!$acc end kernels
  ...
  IF (KRRI >= 1) THEN
    ...
    ELSE
      ...
      &  ZLVOCPEXNM,ZAMOIST,ZATHETA, &
      & PRT, ZDRVSATDT, ZRVSAT, CST, PPABST, KRR)
...
!$acc end kernels
  ...
  CASE ('DEAR')
    ...
    & ZETHETA, KRRI, ZD, ZEMOIST, CST, PTHVREF, ZDRTDZ,  &
    & ZDTHLDZ, PTHLT, ZWORK2, GOCEAN, ZLOCPEXNM, OCOMPUTE_SRC,  &
    & PSRCT, ZAMOIST, ZALPHA, PDIRCOSZW, ZWORK1, TURBN, PDXX, ZVAR, &
...
!$acc end kernels
  ...
  & PCEI, TURBN, PCEI_MIN, PDXX, ZVAR, O2D, HTURBLEN_CL, PDYY, KRR,  &
